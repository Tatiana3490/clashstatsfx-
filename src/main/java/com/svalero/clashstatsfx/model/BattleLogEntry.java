...
public class BattleLogEntry {
    ...
    public String getPlayerName() {return team != null && !team.isEmpty() ? team.get(0).getName() : "Desconocido";}

    public String getOpponentName() {return opponent != null && !opponent.isEmpty() ? opponent.get(0).getName() : "Desconocido";}
